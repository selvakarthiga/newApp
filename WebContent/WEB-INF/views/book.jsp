...
<body>
	<form:form action="bookbus" method="post" modelAttribute="bkbus">
		<center>
			<table align="center" cellspacing="30" border="0">
				<tr>
					<th style="text-align: center" colspan="3">Journey Details</th>
				</tr>
				<tr>
					<td>From</td>
				...
				<tr>
					<td colspan="4" style="text-align: center;"><input
						type="submit" class="button" value="Book Now" /></td>
