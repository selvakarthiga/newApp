			...
			<table  width=80% height=100 cellspacing="30">
				...
				<%for(DetailsBean t : ob) { %>
					<tr style="color: blue;" align="center">
						...
						<td><%=t.getSeat() %></td>
						<td><%=t.getFair() %></td>
						<td><input type="submit" class="button" value="Select Seats"/></td>
				
				</tr>
				<%} %>
				
				<tr><td colspan="8" style="text-align: center;"><a
						href="${pageContext.request.contextPath}/backtoBook"><input
