...
<body>
	...
	<form:form action="adminViewSeats">
		<center>
			<table width=80% height=100 cellspacing="30">
				...
				<tr style="color: blue;" align="center">
					...
					<td><%=t.getSeat()%></td>
					<td><%=t.getFair()%></td>
					<td><input type="submit" class="button" value="View Seats" /></td>
				...
				<tr>
					<td colspan="9" style="text-align: center;"><a
						href="${pageContext.request.contextPath}/backtoAdminView"><input
